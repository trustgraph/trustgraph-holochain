...
//   let expected_entry_hash = "uhCEkU7nwnCzoAkjZaHBFd95hkJsVxVVGF_3T8_TmtDngi3GhMx1R";
//   let expected_link_tag_string = format!(
//     "{}{}{}{}{}{}{}{}{}{}{}",
//     "Ŧ", "→", unicode_nul, unicode_nul, "sushi", unicode_nul, ".800000000", unicode_nul, bucket, unicode_nul, expected_entry_hash );
...
//   let chunks: Vec<&str> = relevant_link_string.split(unicode_nul).collect();
//   println!("153: {:?}", assert_eq!(chunks.len(), 6));
//   assert_eq!(chunks[0], "Ŧ↩");
//   assert_eq!(chunks[1], "");
//   assert_eq!(chunks[2], "sushi");
//   assert_eq!(chunks[3], ".800000000");
...
pub async fn test_create_trust_graph() {
  ...
  for ((agent, conductor, cell), content, value, target) in agent_data {
    // CREATE AGENT TRUST ATOMS
  ...
  assert_eq!(
    ...
    vec![
      TrustAtom {
        ...
        value: Some("0.704".to_string()), // YMMV
        extra: None,
      },
      TrustAtom {
        source_entry_hash: me_b64.clone(),
        ...
        value: Some("0.788167597765363".to_string()), // YMMV
        extra: None,
      },
      // TrustAtom {
      //   source_entry_hash: me_b64.clone(),
